	...
	if self.objects then
		for o,obj in ipairs(self.objects) do
			...
			if obj.type=="item" then
				...
				local noskill = (obj.item.herb and ZGV.Professions:GetSkill("Herbalism").level==0)
					or (obj.item.ore and ZGV.Professions:GetSkill("Mining").level==0)
					or (obj.item.skin and ZGV.Professions:GetSkill("Skinning").level==0)
				obj.toohard = (obj.item.herb and obj.item.herb>ZGV.Professions:GetSkill("Herbalism").level)
					 or (obj.item.ore and obj.item.ore>ZGV.Professions:GetSkill("Mining").level)
					 or (obj.item.skin and obj.item.skin>ZGV.Professions:GetSkill("Skinning").level)
