...
startlevel=100.0,
condition_end=function() return skill('Legion Alchemy')>=800 end,
condition_suggested=function() return skill('Legion Alchemy')>0 and skill('Legion Alchemy')<800 and level>=100 end,
},[[
step
